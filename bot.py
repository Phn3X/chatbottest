    ...
    for event in output['entry']:
        ...
        for message in messaging:
            if message.get('message'):
                ...
                "vacancies":["Hi! Thank you for getting in touch! We don't have any vacancies at the moment. But please feel free to drop off your resume to any of our locations and we would have someone in our HR Department get in touch, if any suitable positions become available."],
